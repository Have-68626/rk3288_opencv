...
final class AppLog {
    ...
    static void log(@NonNull Level level,
        ...
        FileLogSink s = sink;
        if (s != null) {
            // Unconditionally apply masking to all log levels before writing to disk
            // This prevents credentials from leaking via DEBUG/VERBOSE logs, as noted in memory.
